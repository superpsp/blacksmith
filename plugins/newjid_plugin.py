...
register_command_handler(handler_REGJID_command, 'регжид', ['все','разное'], 10, 'Регистрирует аккаунт на указанном Jabber сервере, с указанным паролем (если пароль не указан, он будет сгенерирован автоматически).', 'регжид [аккаунт] [сервер(хост)] [пароль]', ['регжид buberbot xmpp.ru mypassword24','регжид user jabbon.ru'])
