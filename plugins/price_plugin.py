...
register_command_handler(handler_price, 'цена', ['все','инфо'], 10, 'Показывает ориентировочную оценочную стоимость домена\nАвтор: ferym\nПортировал с isida: WitcherGeralt', 'цена <домен>', ['цена ru.gg'])
