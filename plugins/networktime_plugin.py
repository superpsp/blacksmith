...
register_command_handler(handler_msk_time, 'куранты', ['инфо','все'], 10,'Показывает точное московское время, взятое с серверов времени из интернета.','куранты', ['куранты'])
