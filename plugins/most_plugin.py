...
register_command_handler(handler_most_create, 'мост', ['все','разное'], 30, 'Создать мост между конференциями', 'мост [конференция]', ['мост test@conference.jabber.ru'])
register_command_handler(handler_most_delete, 'мост_дел', ['все','разное'], 30, 'Разорвать мост между конференциями', 'мост_делл', ['мост_делл'])
