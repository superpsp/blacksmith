...
register_command_handler(handler_ping, 'пинг', ['все','инфо'], 10, 'Пингует тебя или определённый ник или сервер.', 'пинг [ник]', ['пинг guy','пинг jabber.aq'])
register_command_handler(handler_ping, '.', ['инфо'], 10, 'Пингует тебя или определённый ник или сервер.', '. [ник]', ['. guy','. jabber.aq'])
register_command_handler(handler_ping_stat, 'пингстат', ['все','инфо'], 10, 'Показывает статистику пинга определённого жида или ника, без параметров покажет вашу статистику', 'пингстат [ник/жид]', ['пингстат guy','пингстат jabber.aq'])
