...
#			data = read_url('http://absurdopedia.wikia.com.sixxs.org/wiki/%s' % ((body.replace(' ', '_')).encode('utf-8')), 'Mozilla/5.0')
...
register_command_handler(handler_absurd, 'абсурд', ['все','фан'], 10, 'Поиск статьи в http://absurdopedia.wikia.com', 'абсурд <слово>', ['абсурд пиво'])
