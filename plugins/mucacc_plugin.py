...
#	JCON.SendAndCallForResponse(stanza, handler_afrls_answer, {'type': type, 'source': source, 'nick': nick, 'repl': repl})
	JCON.SendAndCallForResponse(stanza, handler_afrls_answer, {'stanza': stanza, 'type': type, 'source': source, 'nick': nick, 'repl': repl})
...
register_command_handler(command_owner, 'овнер', ['админ','все'], 30, 'Делает юзера владельцем', 'овнер [nick/jid]', ['овнер чел','овнер чел','овнер admin@jrap.ru'])
